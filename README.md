...
* Premade commands. Each command described below takes one particular of premade grid fragments stored in Resources directory. Each "draws" a particular pattern on the
